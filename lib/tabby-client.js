...
// amountFils/currency mirror what api/checkout-session.js already computes
// (AED fils) — this converts to Tabby's plain decimal-string amount format,
// it does not recompute price or shipping.
export const createCheckoutSession = async ({ orderId, amountFils, currency, buyer, order }) => {
  guardTestMode();
